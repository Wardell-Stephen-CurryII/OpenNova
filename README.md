...
- **Tool + skill extensibility** for local tools and user-defined plugins (18 built-in tools)
...
- **18 built-in tools**: file ops, shell execution, git, task tracking, plan mode, sub-agents, skills, web, project guide init
